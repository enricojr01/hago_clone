...
<html>
    <head>
        ...
        <title>Clinic-Service Mapping Master List</title>
    </head>
    <body>
        <h1>List of Clinic-Service Mappings</h1>
		<p>Displays a list of clinics and all the services they provide. </p>
		<table>
			<tr>
				<th>Id</th>
				<th>Clinic Name</th>
			...
			<% 
				for (int i = 0; i < clinicList.size(); i++) {
					...
					String targetPath = String.format(
						"/clinicServiceBeanServlet?action=listServices&clinicId=%s", 
						cb.getId()
					);
					String anchor = String.format(
						"<a href='%s%s'>List Services</a>", 
